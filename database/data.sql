...
('Wendy', 'Undomy', 'wundomy@placeholdermail.com', 'WendyU', '/images/resized/image-1665606763301.jpg', 'd3342jasldjhasjhawlejqwejnqmasdasdasdasdasdasdaasdasdasd32423423492763dajkshdlkj'),
('Sam', 'Gambian', 'sgambian@placeholdermail.com', 'SamTheMan', '/images/resized/image-1665607381564.jpg', 'd1jasdasdasdasdasjhawle234234jqwejnqmwnebmnabasdasds1287361892763dajkshdlkj'),
('Dane', 'Doe', 'demo@placeholdermail.com', 'DemoDane', '/images/resized/image-1665607196672.jpg', '$argon2i$v=19$m=4096,t=3,p=1$vn6B7nd7b/nOXkYg6VPT2Q$AeI9LSP3pKftIEJOYxLE5KMVDcdldA7ASjMPCYhiw/s');
...
values ('Unknown', 'Unknown','/images/resized/image-1665189710661.jpeg', 'This thing has got to be old! It is near the entrance to my office building and it has a real WPA mural vibe to it. I feel like it should get more attention, so come visit this little slice of CO. The building is on the north west corner of Cascade and Rio Grande.', 38.824658112106306, -104.82619374089172, 2),
  ...
  ('Guardian', 'Matthew Carlson', '/images/resized/image-1665184273997.jpg', 'This scary, interesting, and chaotic dude is in the median by the theater. Not sure what it is guarding, but I would NOT mess with this thing. Be sure to check it out next time you are downtown!', 38.83387105305894, -104.82266124016441, 1 ),
  ('Greetings from Colorado Springs', 'Drake Drastik', '/images/resized/image-1665183726746.jpg', 'Great mural depicting some local coolness and celebs, like Nikola Tesla and Elvira! It is on the side of the tattoo shop, across from the church. This one is definitely worth checking out. The previous mural here, done by the same artist, was also really well done. This is certainly a spot to keep an eye on.', 38.84327863655874, -104.85675948410532, 4 );
